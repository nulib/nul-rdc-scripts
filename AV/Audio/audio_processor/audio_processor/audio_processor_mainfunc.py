...
#from audio_processor import audio_supportfuncs
from audio_processor import corefuncs

#TO DO: general cleanup

def aja_mov2ffv1_main():
    #the p identifier is the name of the folder that the preservation file will be output to
    pm_identifier = 'p'
    ac_identifier = 'a'
