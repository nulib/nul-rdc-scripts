...
parser.add_argument('--framerate', '-r', required=False, action='store', dest='framerate', help='Sets framerate for dpx2ffv1 conversion script. Defaults to 24 if not specified')
...
parser.add_argument('--check_runtime', '-c', action='store_true', required=False, help='checks ffv1 runtime against access copy runtime after transcode')
