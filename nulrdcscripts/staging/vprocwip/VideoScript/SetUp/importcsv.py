...
from VideoScript.SetUp.guessdate import guess_date
        ...
        with open(csvInventory, encoding="utf-8") as f:
            ...
            if captureDate:
                ...
                coding_history = generate_coding_history(
                    coding_history, vtr, [tapeBrand, recordMode, region, vtrOut]
                )
                ...
                print(
                    '''"File name column found. Interpreting csv file as 
                      file list"'''
                )
                print("CONTINUE? (y/n)")
                yes = {"yes", "y", "ye", ""}
