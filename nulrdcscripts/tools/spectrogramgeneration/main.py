...
from nulrdcscripts.tools.ffprobemetadatareport import main as ffprobereportmain
...
def generate_spectrogram(input, channel_layout_list, outdir, spectroname, ffmpegpath):
    ...
    for index, item in enumerate(channel_layout_list):
        ...
        output = os.path.join(
            outdir, spectroname + "_spectrogram0" + str(index + 1) + "_s.png"
        )
...
def main():
    ...
    channel_layout_list = ffprobereportmain.input_metadata["techMetaA"]["channels"]
