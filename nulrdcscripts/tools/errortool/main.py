...
def enter_data():
    ...
    if video_id and video_title and project_id:
        ...
        tkin.messagebox.showwarning(title="Error",message="You have not entered a project id, a video id, and/or a video title. Please re-enter data.")
...
audiobuzz_check=tkin.Checkbutton(errors_frame,text="Audio Buzz/Hum", variable=audiobuzz_check_var, onvalue="Audio Buzz/Hum",offvalue="Absent")
audiocrackle_check_var=tkin.StringVar(value="Absent")
audiocrackle_check=tkin.Checkbutton(errors_frame,text="Audio Crackle",variable=audiocrackle_check_var, onvalue="Audio Crackle",offvalue="Absent")
audiodistortion_check_var=tkin.StringVar(value="Absent")
audiodistortion_check=tkin.Checkbutton(errors_frame,text="Audio Distortion",variable=audiodistortion_check_var, onvalue="Audio Distortion",offvalue="Absent")
audiodrop_check_var=tkin.StringVar(value="Absent")
audiodrop_check=tkin.Checkbutton(errors_frame,text="Audio Dropout", variable=audiodrop_check_var, onvalue="Audio Dropout",offvalue="Absent")
audiomuffled_check_var=tkin.StringVar(value="Absent")
audiomuffled_check=tkin.Checkbutton(errors_frame,text="Audio Muffled",variable=audiomuffled_check_var,onvalue="Audio Muffled",offvalue="Absent")
audionoise_check_var=tkin.StringVar(value="Absent")
audionoise_check=tkin.Checkbutton(errors_frame,text="Audio Noise", variable=audionoise_check_var,onvalue="Audio Noise",offvalue="Absent")
bearding_check_var=tkin.StringVar(value="Absent")
bearding_check=tkin.Checkbutton(errors_frame, text ="Bearding",variable=bearding_check_var,onvalue="Bearding",offvalue="Absent")
carrier_leak_check_var=tkin.StringVar(value="Absent")
carrier_leak_check=tkin.Checkbutton(errors_frame, text ="Carrier Leak",variable=carrier_leak_check_var,onvalue="Carrier Leak",offvalue="Absent")
color_smearing_check_var=tkin.StringVar(value="Absent")
color_smearing_check=tkin.Checkbutton(errors_frame, text="Color Smearing",variable=color_smearing_check_var,onvalue="Color Smearing",offvalue="Absent")
creased_check_var=tkin.StringVar(value="Absent")
creased_check=tkin.Checkbutton(errors_frame,text="Creased or Crumpled Tape",variable=creased_check_var,onvalue="Creased or Crumpled Tape",offvalue="Absent")
chromnoise_check_var=tkin.StringVar(value="Absent")
chromnoise_check=tkin.Checkbutton(errors_frame,text="Chrominance Noise",variable=chromnoise_check_var,onvalue="Chrominance Noise",offvalue="Absent")
crosstalk_check_var=tkin.StringVar(value="Absent")
crosstalk_check=tkin.Checkbutton(errors_frame,text="Crosstalk",variable=crosstalk_check_var,onvalue="Crosstalk",offvalue="Absent")
crushed_check_var=tkin.StringVar(value="Absent")
crushed_check=tkin.Checkbutton(errors_frame, text ="Chrushed Setup",variable=crushed_check_var,onvalue="Crushed Setup",offvalue="Absent")
dihedral_check_var=tkin.StringVar(value="Absent")
dihedral_check=tkin.Checkbutton(errors_frame,text="Dihedral Maladjustment",variable=dihedral_check_var,onvalue="Dihedral Maladjustment",offvalue="Absent")
dotcrawl_check_var=tkin.StringVar(value="Absent")
dotcrawl_check=tkin.Checkbutton(errors_frame, text ="Dot Crawl",variable=dotcrawl_check_var,onvalue="Dot Crawl",offvalue="Absent")
dropouts_check_var=tkin.StringVar(value="Absent")
dropouts_check=tkin.Checkbutton(errors_frame,text="Dropouts and Dropout Compensation",variable=dropouts_check_var,onvalue="Dropouts & Dropout Compensation",offvalue="Absent")
egli_check_var=tkin.StringVar(value="Absent")
egli_check=tkin.Checkbutton(errors_frame, text ="Electrical Ground Loop Interference", variable=egli_check_var,onvalue="Electrical Ground Loop Interference",offvalue="Absent")
fluorescent_check_var=tkin.StringVar(value="Absent")
fluorescent_check=tkin.Checkbutton(errors_frame, text ="Fluorescent Strobing",variable=fluorescent_check_var,onvalue="Fluorescent Strobing",offvalue="Absent")
ghost_check_var=tkin.StringVar(value="Absent")
ghost_check=tkin.Checkbutton(errors_frame, text ="Ghosting",variable=ghost_check_var,onvalue="Ghosting",offvalue="Absent")
headclog_check_var=tkin.StringVar(value="Absent")
headclog_check=tkin.Checkbutton(errors_frame,text="Headclogging", variable=headclog_check_var,onvalue="Headclogging",offvalue="Absent")
horiHold_check_var=tkin.StringVar(value="Absent")
horiHold_check=tkin.Checkbutton(errors_frame,text="Horizontal Hold",variable=horiHold_check_var,onvalue="Horizontal Hold",offvalue="Absent")
hueError_check_var=tkin.StringVar(value="Absent")
hueError_check=tkin.Checkbutton(errors_frame, text="Hue Error NTSC",variable=hueError_check_var,onvalue="Hue Error",offvalue="Absent")
hum_check_var=tkin.StringVar(value="Absent")
hum_check=tkin.Checkbutton(errors_frame,text="Hum Trouble",variable=hum_check_var,onvalue="Hum Trouble",offvalue="Absent")
incomp_TVStand_var=tkin.StringVar(value="Absent")
incomp_TVStand=tkin.Checkbutton(errors_frame,text="Incompatibility TV Standards",variable=incomp_TVStand_var,onvalue="Incompatibility in TV Standards",offvalue="Absent")
incomp_inFam_var=tkin.StringVar(value="Absent")
incomp_inFam=tkin.Checkbutton(errors_frame,text="Incompatibility in family of formats",variable=incomp_inFam_var,onvalue="Incompatibility in Family of Formats",offvalue="Absent")
expanshrink_check_var=tkin.StringVar(value="Absent")
expanshrink_check=tkin.Checkbutton(errors_frame,text="Tape Expansion or Shrinkage",variable=expanshrink_check_var,onvalue="Tape Expansion or Shrinkage",offvalue="Absent")
longPlay_check_var=tkin.StringVar(value="Absent")
longPlay_check=tkin.Checkbutton(errors_frame,text="Long Play",variable=longPlay_check_var,onvalue="Long Play",offvalue="Absent")
losscolor_check_var=tkin.StringVar(value="Absent")
losscolor_check=tkin.Checkbutton(errors_frame,text="Loss of Color Lock",variable=losscolor_check_var,onvalue="Loss of Color Lock",offvalue="Absent")
moire_check_var=tkin.StringVar(value="Absent")
moire_check=tkin.Checkbutton(errors_frame,text="Moire Effect",variable=moire_check_var,onvalue="Moire Effect",offvalue="Absent")
scratchwear_check_var=tkin.StringVar(value="Absent")
scratchwear_check=tkin.Checkbutton(errors_frame,text="Scratches and Tape Wear",variable=scratchwear_check_var,onvalue="Scratches and Tape Wear",offvalue="Absent")
shiftheadswitch_check_var=tkin.StringVar(value="Absent")
shiftheadswitch_check=tkin.Checkbutton(errors_frame,text="Shifted Head Switching Point",variable=shiftheadswitch_check_var,onvalue="Headswitching Noise",offvalue="Absent")
skew_check_var=tkin.StringVar(value="Absent")
skew_check=tkin.Checkbutton(errors_frame,text="Skew Error",variable=skew_check_var,onvalue="Skew Error",offvalue="Absent")
stick_check_var=tkin.StringVar(value="Absent")
stick_check=tkin.Checkbutton(errors_frame,text="Sticky Tape Syndrome",variable=stick_check_var,onvalue="Sticky Tape Syndrome",offvalue="Absent")
stiction_check_var=tkin.StringVar(value="Absent")
stiction_check=tkin.Checkbutton(errors_frame, text ="Stiction",variable=stiction_check_var,onvalue="Stiction",offvalue="Absent")
scpe_check_var=tkin.StringVar(value="Absent")
scpe_check=tkin.Checkbutton(errors_frame, text ="Subcarrier Phase Error",variable=scpe_check_var,onvalue="Subcarrier Phase Error",offvalue="Absent")
deform_check_var=tkin.StringVar(value="Absent")
deform_check=tkin.Checkbutton(errors_frame, text="Tape Deformation",variable=deform_check_var,onvalue="Tape Deformation",offvalue="Absent")
misalign_check_var=tkin.StringVar(value="Absent")
misalign_check=tkin.Checkbutton(errors_frame,text="Tape Misalignment",variable=misalign_check_var,onvalue="Tape Misalignment",offvalue="Absent")
quilting_check_var=tkin.StringVar(value="Absent")
quilting_check=tkin.Checkbutton(errors_frame, text ="Quilting",variable=quilting_check_var,onvalue="Quilting",offvalue="Absent")
ringing_check_var=tkin.StringVar(value="Absent")
ringing_check=tkin.Checkbutton(errors_frame, text ="Ringing",variable=ringing_check_var,onvalue="Ringing",offvalue="Absent")
tBCError_check_var=tkin.StringVar(value="Absent")
tBCError_check=tkin.Checkbutton(errors_frame, text="TBC Error",variable=tBCError_check_var,onvalue="TBC Error",offvalue="Absent")
track_check_var=tkin.StringVar(value="Absent")
track_check=tkin.Checkbutton(errors_frame,text="Tracking Error",variable=track_check_var,onvalue="Tracking Error",offvalue="Absent")
vgae_check_var=tkin.StringVar(value="Absent")
vgae_check=tkin.Checkbutton(errors_frame, text ="Vacuum Guide Adjustment Error",variable=vgae_check_var,onvalue="Vacuum Guide Adjustment Error",offvalue="Absent")
ycdelay_check_var=tkin.StringVar(value="Absent")
ycdelay_check=tkin.Checkbutton(errors_frame, text ="Y/C Delay Error",variable=ycdelay_check_var,onvalue="Y/C Delay Error",offvalue="Absent")
ven_check_var=tkin.StringVar(value="Absent")
ven_check=tkin.Checkbutton(errors_frame,text="Venetian-Blind Effect PAL",variable=ven_check_var,onvalue="Venetian-Blind Effect",offvalue="Absent")
vhold_check_var=tkin.StringVar(value="Absent")
vhold_check=tkin.Checkbutton(errors_frame,text="Vertical Hold",variable=vhold_check_var,onvalue="Vertical Hold",offvalue="Absent")
vPictJump_check_var=tkin.StringVar(value="Absent")
vPictJump_check=tkin.Checkbutton(errors_frame,text="Vertical Picture Jumping",variable=vPictJump_check_var,onvalue="Vertical Picture Jumping",offvalue="Absent")
vsync_check_var=tkin.StringVar(value="Absent")
vsync_check=tkin.Checkbutton(errors_frame,text="Vertical Synchronization Error",variable=vsync_check_var,onvalue="VSync Error",offvalue="Absent")
visibleFrameLine_check_var=tkin.StringVar(value="Absent")
visibleFrameLine_check=tkin.Checkbutton(errors_frame, text ="Visible Frame Line",variable=visibleFrameLine_check_var,onvalue="Visible Frame Line",offvalue="Absent")
