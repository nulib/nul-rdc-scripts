...
def main():
    ...
    def enter_data():
        ...
        if video_id and video_title and project_id:
            ...
            csv_file = os.path.abspath((file_output + "/" + project_id + ".csv"))
    ...
    def reset_form():
        ...
        audiobuzz_check.set("Absent")
        audiocrackle_check.set("Absent")
        audiodistortion_check.set("Absent")
        audiodrop_check.set("Absent")
        audiomuffled_check.set("Absent")
        audionoise_check.set("Absent")
        bearding_check.set("Absent")
        carrier_leak_check.set("Absent")
        color_smearing_check.set("Absent")
        creased_check.set("Absent")
        chromnoise_check.set("Absent")
        crosstalk_check.set("Absent")
        crushed_check.set("Absent")
        dihedral_check.set("Absent")
        dotcrawl_check.set("Absent")
        dropouts_check.set("Absent")
        egli_check.set("Absent")
        ghost_check.set("Absent")
        headclog_check.set("Absent")
        horiHold_check.set("Absent")
        hueError_check.set("Absent")
        hum_check.set("Absent")
        incomp_TVStand.set("Absent")
        incomp_inFam.set("Absent")
        expanshrink_check.set("Absent")
        longPlay_check.set("Absent")
        losscolor_check.set("Absent")
        moire_check.set("Absent")
        scratchwear_check.set("Absent")
        shiftheadswitch_check.set("Absent")
        skew_check.set("Absent")
        stick_check.set("Absent")
        stiction_check.set("Absent")
        scpe_check.set("Absent")
        deform_check.set("Absent")
        misalign_check.set("Absent")
        quilting_check.set("Absent")
        ringing_check.set("Absent")
        tBCError_check.set("Absent")
        track_check.set("Absent")
        vgae_check.set("Absent")
        ycdelay_check.set("Absent")
        ven_check.set("Absent")
        vhold_check.set("Absent")
        vPictJump_check.set("Absent")
        vsync_check.set("Absent")
        visibleFrameLine_check.set("Absent")
