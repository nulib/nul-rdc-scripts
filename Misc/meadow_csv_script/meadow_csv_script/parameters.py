...
parser.add_argument('--input', '-i', required=True, action='store', dest='input_path', type=str, help='full path to input folder')
parser.add_argument('--output', '-o', required=True, action='store', dest='output_path', type=str, help='full path to output csv file')
