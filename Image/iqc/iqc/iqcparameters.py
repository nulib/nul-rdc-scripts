...
parser.add_argument('--all', '-a', required=False, action='store_true', dest='all', help='This is equivalent to including the commands --verify_metadata --verify_techdata --verify checksums md5 -o /path/to/input/input-iqc_report.json')
