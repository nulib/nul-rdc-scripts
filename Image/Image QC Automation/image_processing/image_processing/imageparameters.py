...
parser.add_argument('--verify_checksums', required=False, nargs='+', action='store', dest='verify_checksums', help='')
parser.add_argument('--verify_metadata', required='--strict' in sys.argv, action='store_true', dest='verify_metadata', help='')
...
parser.add_argument('--strict', required=False, action='store_true', help='Use with --verify_metadata to enforce exact metadata matching. Will cause truncated IPTC fields to fail')
